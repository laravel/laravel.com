...
class Page implements Htmlable
{
    ...
    {
        return Arr::get($this->metadata, "og.$key") ?? $this->metadata($key, $default);
    }
    ...
    {
        return Arr::get($this->metadata, "twitter.$key") ?? $this->openGraph($key, $default);
    }
    ...
    public function openGraphImage()
    {
        return $this->openGraph('image', function() {
            ...
            return file_exists(public_path($default)) ? $default : 'img/og-image.png';
        });
    }
