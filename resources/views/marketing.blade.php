...
@section('content')
    ...
    <div class="overflow-hidden dark:text-white dark:text-gray-300  ">
        <div class="max-w-screen-xl px-8 mx-auto dark:bg-gray-800 dark:text-white">
        ...
        <section class="py-12 md:py-20 xl:py-28 ">
            <div class="relative max-w-screen-xl px-8 mx-auto ">
                <div style="z-index: -9998" class="hidden md:w-full md:transform md:translate-x-1/4 md:absolute md:-top-16 md:-right-16 md:h-80 md:flex md:items-center lg:w-3/4 lg:right-16 lg:h-96 dark:text-gray-300 dark:bg-gray-800 ">
                ...
                <p class="mt-3 max-w-md text-gray-600 sm:mt-5 lg:mt-8 lg:max-w-xl lg:text-lg xl:max-w-2xl dark:text-gray-300">Laravel is a web application framework with expressive, elegant syntax. We’ve already laid the foundation — freeing you to create without sweating the small things.</p>
    ...
    <div class="relative py-16 overflow-hidden md:py-40 lg:py-64 xl:py-72 dark:bg-gray-800">
        <div class="relative max-w-screen-xl px-8 mx-auto space-y-16 md:space-y-0 md:flex md:items-center">
            <div style="z-index: -9999; width: 120%" class="hidden md:transform md:-translate-x-1/2 md:absolute md:inset-y-0 md:left-0 md:h-full md:flex md:items-center">
                ...
                @if (SHOW_VAPOR)
                    ...
                    <div class="md:w-1/2 md:pl-8 lg:pl-24 dark:bg-gray-800">
                        <h1 class="font-medium text-3xl tracking-tight sm:text-4xl lg:text-5xl lg:leading-tight xl:text-5xl  dark:text-gray-300">Laravel Vapor</h1>
                        <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg dark:text-gray-300 ">Laravel Vapor is a serverless deployment platform for Laravel, powered by AWS. Launch your Laravel infrastructure on Vapor and fall in love with the scalable simplicity of serverless.</p>
                        <x-button.primary class="mt-6 sm:mt-8 md:mt-10" href="https://vapor.laravel.com" target="_blank">
                            Learn More
                        </x-button.primary>
                    </div>
                @else
                    <div class="max-w-lg md:max-w-auto md:w-1/2 dark:bg-gray-800">
                        <img class="w-full shadow-lg" src="/img/homepage/forge.jpg" alt="Forge">
                    </div>
                    <div class="md:w-1/2 md:pl-8 lg:pl-24">
                        <h1 class="font-medium text-3xl tracking-tight sm:text-4xl lg:text-5xl lg:leading-tight xl:text-5xl dark:text-gray-300">Laravel Forge</h1>
                        <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg dark:text-gray-300 ">Instant PHP Platforms on DigitalOcean, Linode, and more. Featuring push-to-deploy, Redis, queues, and everything else you could need to launch and deploy impressive Laravel applications.</p>
    ...
    <div class="max-w-screen-xl px-8 mx-auto">
        ...
        <h1 class="mx-auto mt-4 font-medium text-3xl tracking-tight text-center sm:text-4xl lg:text-5xl lg:leading-tight xl:text-5xl dark:text-gray-300">The Laravel Ecosystem</h1>
            ...
            <li>
                <a href="https://vapor.laravel.com" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl dark:text-gray-200">Vapor</div>
                        <span class="text-gray-600 dark:text-gray-300 text-xs">Serverless Platform</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://forge.laravel.com" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Forge</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Server Management</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://envoyer.io" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Envoyer</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Zero Downtime Deployment</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/horizon" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Horizon</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Queue Monitoring</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://nova.laravel.com/" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Nova</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Administration Panel</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/broadcasting" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Echo</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Realtime Events</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://lumen.laravel.com" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Lumen</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Micro-Framework</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/homestead" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Homestead</div>
                    <span class="text-gray-600  dark:text-gray-300 text-xs">Pre-Packaged Vagrant Box</span>
                </div>
                </a>
            </li>
            <li>
                <a href="https://spark.laravel.com" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Spark</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">SaaS App Scaffolding</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/valet" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Valet</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Dev Environment for Macs</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/mix" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Mix</div>
                    <span class="text-gray-600  dark:text-gray-300 text-xs">Webpack Asset Compilation</span>
                </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/billing" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Cashier</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Subscription Billing Integration</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/dusk" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Dusk</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Browser Testing and Automation</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/passport" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Passport</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Painless OAuth2 Implementation</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/scout" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Scout</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Full-Text Search</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/socialite" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Socialite</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">OAuth Authentication</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="/docs/{{DEFAULT_VERSION}}/telescope" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Telescope</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">Debug Assistant</span>
                    </div>
                </a>
            </li>
            <li>
                <a href="https://jetstream.laravel.com" class="flex items-center p-4 shadow-lg">
                    ...
                    <div class="ml-4 leading-5">
                        <div class="text-2xl  dark:text-gray-200">Jetstream</div>
                        <span class="text-gray-600  dark:text-gray-300 text-xs">App Scaffolding</span>
                    </div>
                </a>
            </li>
        </ul>
    ...
    <div class="py-16 overflow-hidden md:py-40 lg:py-64 xl:py-80 dark:bg-gray-800 dark:text-white">
        <div class="relative max-w-screen-xl mx-auto px-8 space-y-12 md:space-y-0 md:flex md:items-center">
            ...
            <div class="md:w-1/2">
                <h6 class="text-gray-600 dark:text-white font-medium text-lg ">Resources</h6>
                ...
                <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg dark:text-gray-200">Whether you’re a solo developer or a 20-person team, getting started is simple thanks to our great community.</p>
                <ul class="mt-6 max-w-md grid grid-cols-2 gap-4 text-gray-600 dark:text-gray-300 font-medium text-sm leading-4 list-custom sm:mt-8">
            ...
            <div class="pr-12 md:w-1/2 md:px-12 dark:text-gray-200">
                <div class="relative max-w-lg p-6 bg-white  dark:bg-gray-800 shadow-lg lg:p-16">
