...
<html lang="en">
    ...
    <body class="language-php {{ isset($_COOKIE['docs_theme']) && $_COOKIE['docs_theme'] == 'dark' ? 'dark' : '' }}">
                ...
                <div class="contain">
                    <section class="partner_block">
                        <div class="content">
                            ...
                            <p>Laravel Partners are elite shops providing top-notch Laravel development and consulting.
                                Each of our partners can help you craft a beautiful, well-architected project.</p>
                        </div>
                    ...
                    <div class="contain">
                        ...
                        <div class="footer_content">
                                ...
                                <div class="nav_col">
                                    ...
                                    <div class="footer_nav_contain">
                                        <ul>
                                            ...
                                            <li><a href="/docs/{{DEFAULT_VERSION}}/installation">Getting Started</a>
                                            </li>
                                            <li><a href="/docs/{{DEFAULT_VERSION}}/routing">Routing</a></li>
                                            <li><a href="/docs/{{DEFAULT_VERSION}}/blade">Blade Templates</a></li>
                                            <li><a href="/docs/{{DEFAULT_VERSION}}/authentication">Authentication</a>
                                            </li>
                            ...
                            <div class="footer_info">
                                <p class="small">Laravel is a web application framework with expressive, elegant syntax.
                                    We believe development must be an enjoyable and creative experience to be truly
                                    fulfilling. Laravel attempts to take the pain out of development by easing common
