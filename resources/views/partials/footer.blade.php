@php
    $links = [
        [
            ...
            'links' => [
                'Our Team' => '/team',
                'Release Notes' => App\Documentation::getLink('releases'),
                'Getting Started' => App\Documentation::getLink('installation'),
                'Routing' => App\Documentation::getLink('routing'),
                'Blade Templates' => App\Documentation::getLink('blade'),
                'Authentication' => App\Documentation::getLink('authentication'),
                'Authorization' => App\Documentation::getLink('authorization'),
                'Artisan Console' => App\Documentation::getLink('artisan'),
                'Database' => App\Documentation::getLink('database'),
                'Eloquent ORM' => App\Documentation::getLink('eloquent'),
                'Testing' => App\Documentation::getLink('testing'),
            ],
        ],
        [
            'title' => 'Resources',
