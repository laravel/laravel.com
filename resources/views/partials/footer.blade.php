...
<footer style="background: linear-gradient(0deg,#fff 90%,hsla(0,0%,100%,0))" class="relative z-30   dark:bg-gray-800 dark:text-gray-300">
    <div class="relative z-20 overflow-x-hidden dark:bg-gray-800 dark:text-white">
        <div class="relative max-w-screen-2xl mx-auto sm:px-8">
            <div class="absolute inset-0 flex flex-col px-4 lg:px-12 xl:px-16 ">
                <div class="flex-1"></div>
                <div class="flex-1 bg-gray-100 dark:bg-gray-800 dark:text-gray-300"></div>
            </div>
            <div class="relative max-w-screen-xl mx-auto px-8 dark:bg-gray-800 dark:text-gray-300">
                <section class="relative z-10 p-6 bg-white dark:bg-gray-700 shadow-lg md:flex md:items-center md:p-12 lg:p-16">
                    <div class="content md:pr-12">
                        ...
                        <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg dark:text-gray-300">Laravel Partners are elite shops providing top-notch Laravel development and consulting. Each of our partners can help you craft a beautiful, well-architected project.</p>
                    </div>
        ...
        <div class="max-w-screen-2xl mx-auto px-4 lg:px-12 xl:px-16  ">
            <div class="px-8 pb-12 bg-gray-100 dark:bg-gray-800 dark:text-white xl:px-20">
                <div>
