@php
    $links = [
        [
            ...
            'links' => [
                'Our Team' => '/team',
                'Release Notes' => App\DocsLink::get('releases'),
                'Getting Started' => App\DocsLink::get('installation'),
                'Routing' => App\DocsLink::get('routing'),
                'Blade Templates' => App\DocsLink::get('blade'),
                'Authentication' => App\DocsLink::get('authentication'),
                'Authorization' => App\DocsLink::get('authorization'),
                'Artisan Console' => App\DocsLink::get('artisan'),
                'Database' => App\DocsLink::get('database'),
                'Eloquent ORM' => App\DocsLink::get('eloquent'),
                'Testing' => App\DocsLink::get('testing'),
            ],
        ],
        [
            'title' => 'Resources',
