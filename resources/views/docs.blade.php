                ...
                <nav>
                    <div class="navigation_contain">
                        ...
                        <script async type="text/javascript"
                            src="//cdn.carbonads.com/carbon.js?serve=CKYILK3E&placement=laravelcom" id="_carbonads_js">
                        </script>
                ...
                <header class="docs_actions">
                    <div class="theme_mode">
                        <div class="input-group">
                            <label>Docs Theme</label>
                            <div class="custom_select">
                                <select id="theme_switcher" aria-label="Laravel docs theme">
                                    <option value="light">Light</option>
                                    <option value="dark"
                                        {{ isset($_COOKIE['docs_theme']) && $_COOKIE['docs_theme'] == 'dark' ? 'selected' : '' }}>
                                        Dark</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="input_group">
                            ...
                            <div class="custom_select">
                                <select id="version_switcher" aria-label="Laravel version">
                                    ...
                                    <option {{ $currentVersion == $key ? 'selected' : '' }}
                                        value="{{ url('docs/'.$key.$currentSection) }}">{{ $display }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <section class="docs_main">
                        ...
                        <blockquote>
                            <div class="callout">
                                ...
                                <p class="content">
                                    <strong>WARNING</strong> You're browsing the documentation for an old version of
                                    Laravel.
                                    Consider upgrading your project to <a
                                        href="{{ route('docs.version', DEFAULT_VERSION) }}">Laravel
                                        {{ DEFAULT_VERSION }}</a>.
                                </p>
                            </div>
                        </blockquote>
