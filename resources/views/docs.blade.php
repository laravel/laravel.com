    ...
    <div class="relative overflow-auto" id="docsScreen">
        <div class="relative lg:flex lg:items-start  ">
            <aside
                ...
                class="fixed top-0 bottom-0 left-0 z-20 h-full w-16 flex flex-col bg-gradient-to-b light:from-gray-100 to-white transition-all duration-300 overflow-hidden lg:sticky lg:w-80 lg:flex-shrink-0 lg:flex lg:justify-end lg:items-end 2xl:max-w-lg 2xl:w-full dark:bg-gray-800 dark:text-white"
