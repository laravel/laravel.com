                        ...
                        <li>
                            <div class="space-y-4">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover shadow-lg rounded-lg" loading="lazy" width="400" height="400" src="https://unavatar.vercel.app/github/{{ $staff['github_username'] }}" alt="{{ $staff['name'] }}">
                                </div>
