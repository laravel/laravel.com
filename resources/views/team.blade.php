                    ...
                    <section class="py-12 md:py-20 xl:py-28">
                        ...
                        <div class="max-w-screen-xl mx-auto px-8 space-y-8 md:space-y-0 md:flex md:items-end">
                            <div class="md:flex-1">
                                ...
                                <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg">Laravel is a team of developers from all around the world.</p>
                            </div>
                        </div>
                    </section>
                </div>
                        ...
                        <li>
                            <div class="space-y-4">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover shadow-lg rounded-lg" src="https://unavatar.vercel.app/github/{{ $staff['github_username'] }}" alt="{{ $staff['name'] }}">
                                </div>
