<?php
    $news = Illuminate\Support\Arr::random(['nova', 'forge', 'vapor', 'pulse', 'laracon']);
?>
...
<div class="hidden lg:flex items-center justify-center bg-gradient-to-b from-red-500 to-red-600 p-2 text-center text-white text-sm">
    ...
    @elseif ($news === 'laracon')
        ...
        <div class="mt-px ml-1">
            Join us in Dallax, TX! Tickets are now available for <a href="https://laracon.us" class="underline">Laracon</a>.
        </div>
