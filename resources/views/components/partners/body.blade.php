        ...
        <div class="md:w-3/4 md:ml-auto lg:grid lg:gap-6 lg:grid-cols-5 xl:gap-16 xl:grid-cols-12">
            ...
            <div class="mt-12 lg:mt-0 lg:col-span-2 xl:col-span-5">
                <div class="p-12 bg-white shadow-lg xl:p-16">
                    ...
                    <ul
                        class="mt-3 grid grid-cols-1 gap-4 list-custom font-medium text-sm text-gray-600 leading-4 md:grid-cols-2 lg:grid-cols-1">
                        {{ $proficiencies }}
                    </ul>
                </div>
                <ul class="mt-12 flex items-center space-x-4">
                    @isset($twitter)
                        <li>
                            <a href="{{ $twitter }}">
                                <img class="opacity-25" src="/img/social/x.min.svg" alt="Twitter">
                            </a>
                        </li>
                        @endif
                        @isset($github)
