<div class="relative">
    <div class="max-w-screen-xl mx-auto px-8 py-12 lg:py-24">
        <div style="width: 130%;z-index: -9998" class="hidden md:transform md:-translate-x-1/2 md:absolute md:inset-y-0 md:left-0 md:w-full md:flex md:items-center xl:left-16 2xl:left-32">
            <video poster="{{ asset('img/blocks/blocks_2.jpg') }}" playsinline autoplay muted loop>
                <source src="{{ asset('img/blocks/blocks_2.mp4') }}" type="video/mp4">
            </video>
        </div>
            ...
            <div class="mt-12 lg:mt-0 lg:col-span-2 xl:col-span-5">
                ...
                <ul class="mt-12 flex items-center space-x-4">
                    @isset ($twitter)
                        <li>
                            <a href="{{ $twitter }}">
                                <img class="opacity-25" src="{{ asset('img/social/twitter.min.svg') }}" alt="Twitter">
                            </a>
                        </li>
                    @endif
                    @isset ($github)
                        <li>
                            <a href="{{ $github }}">
                                <img class="opacity-25" src="{{ asset('img/social/github.min.svg') }}" alt="GitHub">
                            </a>
                        </li>
                    @endif
                    @isset ($linkedin)
                        <li>
                            <a href="{{ $linkedin }}">
                                <img class="opacity-25" src="{{ asset('img/social/linkedin.min.svg') }}" alt="LinkedIn">
                            </a>
                        </li>
                    @endif
                    @isset ($facebook)
                        <li>
                            <a href="{{ $facebook }}">
                                <img class="opacity-25" src="{{ asset('img/social/facebook.min.svg') }}" alt="Facebook">
                            </a>
                        </li>
                    @endif
                </ul>
